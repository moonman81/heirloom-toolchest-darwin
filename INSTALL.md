# INSTALL — POSIX/SVR4 core utilities (Heirloom Darwin port)
...
`uninstall` reads the manifest at `.install-manifest-toolchest.txt`
...
`https://github.com/moonman81/heirloom-toolchest-darwin/issues`
with:
