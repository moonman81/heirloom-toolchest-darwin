...
Chain of custody for the `toolchest` package (POSIX/SVR4 core utilities) as vendored by
this Darwin port.
...
- **Upstream tarballs**: `/opt/heirloom/src/original/heirloom-toolchest-*/`
...
- This port: `moonman81 (2026). heirloom-toolchest-darwin.
