...
electronic mail — the SVR4 mail utility.
...
- **C sources**: Dout.c, Tout.c, add_recip.c, casncmp.c, cat.c, ckdlivopts.c, cksaved.c, clr_hinfo.c, copyback.c, copylet.c, copymt.c, copystream.c (+50 more)
- **Headers**: heirloom_flags.h, libmail.h, mail.h, maillock.h, s_string.h
