...
- **C sources**: ac.c, alloc.c, egrep.c, fgrep.c, ggrep.c, grep.c, grid.c, plist.c, rcomp.c, sus.c, svid3.c
- **Headers**: alloc.h, config.h, grep.h, heirloom_flags.h
- **Build**: Makefile, Makefile.mk
- **Man pages**: egrep.1, fgrep.1, grep.1
