...
- **C sources**: _collelem.c, _collmult.c, bracket.c, onefile.c, regcomp.c, regdfa.c, regerror.c, regexec.c, regfree.c, regnfa.c, regparse.c, stubs.c
- **Headers**: colldata.h, re.h, regdfa.h, regex.h, wcharm.h
