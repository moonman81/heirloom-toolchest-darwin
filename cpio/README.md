...
copy in / out — SVR4 archive format.
...
- **C sources**: blast.c, cpio.c, crc32.c, expand.c, explode.c, flags.c, inflate.c, nonpax.c, pax.c, unshrink.c, version.c
- **Headers**: blast.h, cpio.h, heirloom_flags.h, unzip.h
- **Build**: Makefile, Makefile.mk
- **Man pages**: cpio.1, pax.1
